        ...
        <div className="container mx-auto flex px-5 py-4 md:flex-row flex-col">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <h2 className="text-lg flex text-center text-gray-200 md:text-xl md:text-left tracking-wider animItem">
              Hello! My name is Bharat and I enjoy creating things that live on
              the internet. I am a full-stack developer and designer focussed on
              problem-solving with crafting clean and user-friendly code and
              designs.
            </h2>
            <br />
            <h2 className="text-lg flex text-center text-gray-200 md:text-xl md:text-left tracking-wider animItem">
              I have serous passion for coding and I find immense satisfaction
              in solving complex problems and turning innovative ideas into
              reality. I embrace every project and always striving for
